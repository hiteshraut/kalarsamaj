...
if(isset($_POST['email'])) {
    ...
    function died($error) {
        ...
        echo "<h4>Whoops!</h4><h5>There appears to be something wrong with your completed form.</h5>";
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message = "Details are given below.\n\n";
...
<div class="sent-message"><h4>Your message has been sent. Thank you!</h4> <h5>We will contact you as soon as possible.</h5>
  </div>
